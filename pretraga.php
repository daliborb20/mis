...
<div class="container" id="container__forma">
    <form id="forma2"  method="POST">
        ...
        <label class="col-md-12 col-xs-12"for="datum_misljenja">Pretraga po datumu</label>
...
if(isset($_POST['Pretrazi'])) {
    ...
    if($broj_misljenja == "" and  $broj_biltena == "" and  $datum_misljenja == "" and $kljucni_pojam != "") { 
        ...
        echo "5";
         ...
         echo "<h4 class='alert alert-danger'>Morate uneti bar jedan kriterijum za pretrazivanje</h4>";
        echo "6";
         die;
    }
    //=======================================================kraj petlje 
